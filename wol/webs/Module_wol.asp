...
<link rel="shortcut icon" href="res/icon-wol.png">
<link rel="icon" href="res/icon-wol.png">
<title>软件中心 - Wake on LAN</title>
...
document.form.SystemCmd.value = "wol --if br0 " + document.form.destIP.value;
// document.form.submit();
var uid = parseInt(Math.random() * 100000000);
var postData = {"id": uid, "method": "wol_config.sh", "params": [1], "fields": {"wol_MAC": document.form.destIP.value} };
...
code += '<tr><td style="color:#FFCC00;"><#2556#></td></tr>';
else{
...
document.getElementById("check_mac").innerHTML="<#450#>";
...
childsel.style.color="#FFCC00";
obj.parentNode.appendChild(childsel);
document.getElementById("check_mac").innerHTML="<#411#>";
document.getElementById("check_mac").style.display = "";
return false;
}else{
...
<input type="hidden" name="current_page" value="Module_wol.asp">
<input type="hidden" name="next_page" value="Module_wol.asp">
...
<div>&nbsp;</div>
<div class="formfonttitle"><#2968#> - <#2985#></div>
...
<input class="button_gen" id="cmdBtn" onClick="onSubmitCtrl(this, ' Refresh ')" type="button" value="<#2986#>">
...
<thead>
<tr>
<td colspan="2" id="GWStatic"><#2979#>&nbsp;(<#2774#>&nbsp;32)</td>
</tr>
</thead>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,10);"><#1647#> (<#3125#>)</a></th>
<th><#2773#></th>
</tr>
<tr>
<td width="80%">
...
<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullLANIPList(this);" title="<#3284#>">
...
<div class="apply_gen">
<input type="button" name="button" class="button_gen" onclick="applyRule();" value="<#288#>"/>
</div>
</td>
</tr>
</table>
